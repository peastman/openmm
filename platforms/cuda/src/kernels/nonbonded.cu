...
extern "C" __global__ void computeNonbonded(
        ...
        const ushort2* __restrict__ exclusionTiles, unsigned int startTileIndex, unsigned int numTileIndices, int numTilesWithExclusions, int firstExclusionTile, int lastExclusionTile
#ifdef USE_CUTOFF
